...
constexpr float ImportantDungeonNoticeWidth = 560.0f;
constexpr float ImportantDungeonNoticeRowHeight = 42.0f;
constexpr float ImportantDungeonNoticeGap = 8.0f;
constexpr float ImportantDungeonNoticeBottomYRatio = 0.72f;
constexpr int ImportantDungeonNoticeMaxVisible = 3;
constexpr float ImportantDungeonNoticeLifetime = 4.6f;
constexpr float ImportantDungeonNoticeFadeStart = 3.5f;
constexpr float ImportantDungeonNoticeMergeSeconds = 0.8f;
